...
function Navbar({ title }) {
  ...
  return (
    <>
      ...
      <div
        className={`flex lg:h-[100vh] h-[100vh/2] flex-col gap-y-6 items-center w-48 overflow-hidden text-gray-700 bg-gray-100 rounded ${
          mobileNav === true
            ? "block absolute z-10 mt-[3rem] ml-0 h-1/2 animate-fade-right"
            : "hidden"
        } lg:flex lg:sticky top-0 lg:h`}
      >
        ...
        {/* Account */}
        <Link
          className="flex items-center justify-center w-full h-16 mt-auto bg-gray-200 hover:bg-gray-300 text-black"
          to="/user/account"
        >
          <svg
