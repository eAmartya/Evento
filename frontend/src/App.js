    ...
    <>
      <Routes>
        ...
        <Route
          ...
          exact
          element={
            userLogged === "true" ? <Events /> : <Navigate to="/signup" />
          }
        />
        ...
        <Route
          ...
          exact
          element={
            userLogged === "true" ? <Search /> : <Navigate to="/signup" />
          }
        />
        <Route
          path="/participatedEvent"
          exact
          element={
            userLogged === "true" ? <ParticipatedEvents /> : <Navigate to="/" />
          }
        />
        <Route
          path="/upcomingEvent"
          exact
          element={
            userLogged === "true" ? <UpcomingEvent /> : <Navigate to="/" />
          }
        />
        <Route
          path="/user/account"
          exact
          element={
            userLogged === "true" || adminLogin === "true" ? (
              <Account />
            ) : (
              <Navigate to="/" />
            )
        ...
        <Route
          ...
          exact
          element={<AdminUpcomingEvent />}
        />
        <Route
          path="/admin/completedEvent"
          exact
